          ...
          879: (t, e, n) => {
            n.r(e),
              n.d(e, {
                ...
                getExistingTemplate: () => i,
                getProductData: () => r,
                getSvgHtml: () => d,
                multipleItemFormScript: () => c,
                shoppingFormScript: () => l,
                standardFormScript: () => s,
              });
            var a = n(121);
            const o = () => {
              ...
              n.addType(a.typeBasicForm, {
                ...
                model: {
                  defaults: {
                    ...
                    traits: [{ type: a.productDataTrait, name: "product" }],
                    ...
                    init() {
                      this.on("change:attributes:selectedData", () => {
                        ...
                        if (a.size) {
                          ...
                          const i = o.find("#sizeSelect")[0].get("components");
                          i.reset(),
                            i.add(
                  ...
                  model: {
                    ...
                    init() {
                      this.on("change:attributes:selectedData", () => {
                        ...
                        const a = JSON.parse(this.getAttributes().selectedData),
                          i = t.getWrapper();
                        i.find("#orderSumList")[0].get("components").reset();
                        const r = i.find(".productId")[0],
                          s = i.find(".productPrice")[0];
                        if (
                          (s.set("attributes", {
                            value: a.price,
                            name: "productPrice",
                          ...
                          const t = a.size.split(","),
                            e = a.color.split(","),
                            n = i.find(".sizeColorAndQuantity")[0];
                          n.addAttributes({
          ...
          440: function (t, e, n) {
            ...
            e["default"] = (t, ...e) =>
              a(void 0, [t, ...e], void 0, function* (t, e = {}) {
                ...
                t.on("load", () => {
                  (0, l.getExistingTemplate)(), t.runCommand("sortBlocks");
                }),
                  t.on("update", () => {
