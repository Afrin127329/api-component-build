      ...
      var t = {
          879: (t, n, e) => {
            ...
            async function r() {
              const t = document.location.href,
                n = new URL(t),
                e = new URLSearchParams(n.search).get("id");
              try {
                const t = await fetch(
                    `${
                      document.location.protocol + "//" + document.location.host
                    }/api/dev/user/landing-page/${e}`,
                    {
                      method: "GET",
                  ...
                  n = await t.json();
                if (n.data)
                  editor.setComponents(n.data.content),
                    editor.setStyle(n.data.css),
                    localStorage.setItem("gjsProject", n.data.project_data);
                else {
          ...
          476: function (t, n, e) {
            ...
            n["default"] = (t, n) =>
              o(void 0, void 0, void 0, function* () {
                const { block: e, label: o, id: s, category: c } = n;
                if (e) {
                  l =
                  ...
                  try {
                    ...
                    (n = (yield o.json()).data),
                      t.BlockManager.add(s[0], {
                        ...
                        category: { id: c[1], label: c[1], open: !1 },
                ...
                t.BlockManager.add("link-block", {
                  label: "Link Block",
                  category: { id: c[0], label: c[0], open: !0 },
                  attributes: { class: "block-full-width" },
                  ...
                  t.BlockManager.add("image", {
                    label: "Image",
                    category: { id: c[2], label: c[2], open: !1 },
              ...
              (n["default"] = (t) => {
                t.Commands.add("save-template", {
                  run: () =>
                    e(void 0, void 0, void 0, function* () {
                      const n = t.getHtml(),
                        ...
                        r = new URL(i),
                        l = new URLSearchParams(r.search).get("id"),
                        s = { id: l, html: a, css: e, projectData: o },
                        c = `${document.location.protocol}//${document.location.host}/api/dev/user/landing-page/${l}/save`,
                        d = yield fetch(c, {
                          method: "POST",
                          headers: { "Content-Type": "application/json" },
                  ...
                  t.Commands.add("sortBlocks", {
                    run: (t) => {
                      const n = t.BlockManager.getAll();
                      if (n) {
                        n.comparator = function (t) {
                          const n = t.get("category");
                          return (
                            n &&
                              (null == n ? void 0 : n.attributes) &&
                              ("Blog" === n.attributes.label &&
                                n.set("open", !1),
                              "Extra" === n.attributes.label &&
                                n.set("open", !1)),
                            t.getCategoryLabel().toLowerCase()
                          );
                        };
                        const e = n.sort();
                        t.BlockManager.render(e);
                      }
                    },
                  });
              });
          ...
          126: (t, n, e) => {
            ...
            (n.typeBasicForm = "basicForm"),
              ...
              (n.typeShoppingForm = "shoppingForm"),
              (n["default"] = (t, e) => {
                const { Components: i } = t,
                  { label: r } = e;
                let l;
                const s = e.classPrefix,
                  ...
                  i.addType(n.typeStandardForm, {
                    ...
                    model: {
                      defaults: {
                        ...
                        name: r[1],
                        attributes: {
                          class: `${s} ${s}-container standardForm`,
                          method: "post",
                          action: `${
                            document.location.protocol +
                            "//" +
                      ...
                      init() {
                        this.on("change:attributes:selectedData", () => {
                          ...
                          const e = JSON.parse(
                            ...
                            a = o.find(".productId")[0],
                            r = o.find(".productPrice")[0],
                            l = o.find(".showProduct")[0];
                          l.get("components").reset();
                          const s = l.get("components");
                          if (
                            (a && r && l
                              ? (a.set("attributes", {
                                  value: e.id,
                      ...
                      init() {
                        this.on("change:attributes:selectedData", () => {
                          ...
                          const e = JSON.parse(
                            ...
                            a = t.getWrapper();
                          a.find("#orderSumList")[0].get("components").reset();
                          const r = a.find(".productId")[0],
                            l = a.find(".productPrice")[0];
                          if (
                            (l.set("attributes", {
                              value: e.price,
                              name: "productPrice",
                            ...
                            const t = e.size.split(","),
                              n = e.color.split(","),
                              i = a.find(".sizeColorAndQuantity")[0];
                            i.addAttributes({
                            ...
                            a.find(".colorList").forEach((t) => {
                              ...
                              n.forEach((t) => {
                                ...
                                console.log(t),
                                  t.includes("#")
                                    ? e.add(
                                        `<option value="${t}" style="background-color: ${o};">${n}</option>`
                                      )
                                    : e.add(
                      ...
                      init() {
                        this.on("change:attributes:selectedData", () => {
                          ...
                          if (
                            ...
                            const r = o.find(".sizeItem")[0].get("components");
                            t.forEach((t) => {
                              r.add(`<option value="${t}">${t}</option>`);
                            });
                            const l = o.find(".colorItem")[0].get("components");
                            n.forEach((t) => {
                              const [n, e] = t.split("-");
                              e && e.startsWith("#")
                                ? l.add(
                                    `<option value="${t}" style="background-color: ${e};">${n}</option>`
                                  )
                                : t.startsWith("#")
                                ? l.add(
                                    `<option value="${t}" style="background-color: ${t};">${t}</option>`
                                  )
                                : l.add(`<option value="${t}">${t}</option>`);
                            });
                          }
                          let l =
                              document.head.querySelector(
          ...
          440: function (t, n, e) {
            ...
            n["default"] = (t, ...n) =>
              o(void 0, [t, ...n], void 0, function* (t, n = {}) {
                ...
                t.on("load", () => {
                  (0, s.getData)(), t.runCommand("sortBlocks");
                }),
                  t.on("update", () => {
