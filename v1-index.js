  ...
  () =>
    (() => {
      ...
      var e = function () {
          ...
          var e = document.getElementById("decrease");
          null !== e &&
            e.addEventListener("click", function () {
              return t(-1);
            });
          var o = document.getElementById("increase");
          null !== o &&
                          ...
                          this.on(
                            ...
                            function () {
                              var e,
                                o,
                                a,
                                i = n.getAttributes().selectedData;
                              console.log(i);
                              var r = t.getWrapper(),
                                s =
                              ...
                              if (i.size) {
                                var b = i.size.split(","),
                                  h = r.find("#size")[0],
                                  f = h.get("components");
                                f.reset(), h.set("style", { display: "block" });
                                var g = f
                              ...
                              P(
                                {
                                  ...
                                  label: o[1],
                                  category: "Form",
                                  content: { type: h, data: _, components: A },
                                },
                                e
                              )
                            ),
                              ...
                              P(
                                {
                                  ...
                                  label: o[2],
                                  category: "Form",
                                  content: { type: f, data: _, components: I },
                                },
                                e
                              )
                            ),
