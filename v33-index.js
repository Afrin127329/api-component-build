          ...
          879: (t, n, e) => {
            ...
            const o = function () {
                document.addEventListener("DOMContentLoaded", function () {
                  ...
                  function p(t) {
                    if (r && l) {
                      const n = parseFloat(r.value) * t;
                      (l.textContent = "৳ " + n.toFixed(2)), console.log(l);
                    }
                  }
                  function m() {
                  ...
                  null !== d && d.addEventListener("click", () => s(1)),
                    i.addEventListener("click", function () {
                      ...
                      (l.className = "flex items-center justify-between gap-4"),
                        (l.innerHTML =
                          '<dl class="flex items-center justify-between gap-3 w-full"><dt class="text-base font-normal text-gray-500">${size} - ${color} x ${quantity}</dt><dd class="text-base font-medium text-gray-900">৳${totalPrice.toFixed(2)}</dd></dl><button type="button" class="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500 remove-item"><svg class="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 17.94 6M18 18 6.06 6" /></svg>Remove</button>');
                      document
