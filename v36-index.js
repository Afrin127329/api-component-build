                  ...
                  l &&
                    ...
                    i.addEventListener("click", function () {
                      ...
                      (p.className = "flex items-center justify-between gap-4"),
                        (p.innerHTML = `<dl class="flex items-center justify-between gap-3 w-full"><dt class="text-base font-normal text-gray-500">${l} - ${i} x ${s}</dt><dd class="text-base font-medium text-gray-900">৳${d.toFixed(
                          2
