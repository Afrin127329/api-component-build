          ...
          476: function (t, n, e) {
            ...
            n["default"] = (t, n) =>
              o(void 0, void 0, void 0, function* () {
                const { block: e, label: o, id: l, category: c } = n;
                if (e) {
                  s =
                  ...
                  run: () =>
                    e(void 0, void 0, void 0, function* () {
                      const n = t.getHtml(),
                        ...
                        l = { id: s, html: a, css: e, projectData: o },
                        c = `${document.location.protocol}//${document.location.host}/api/dev/user/landing-page/${s}/save`,
                        d = yield fetch(c, {
                          method: "POST",
                          headers: { "Content-Type": "application/json" },
          ...
          476: function (t, n, e) {
            ...
            n["default"] = (t, n) =>
              a(void 0, void 0, void 0, function* () {
                const { block: e, label: a, id: l, category: c } = n;
                if (e) {
                  s =
                    "localhost:8080" === document.location.host
                      ? "https://dev.chepapest.com/api/dev/products"
                  ...
                  run: () =>
                    e(void 0, void 0, void 0, function* () {
                      const n = t.getHtml(),
                        ...
                        r = new URL(i),
                        s = new URLSearchParams(r.search).get("id"),
                        l = { id: s, html: o, css: e, projectData: a },
                        c = `${document.location.protocol}//${document.location.host}/api/dev/user/landing-page/${s}/save`,
                        d = yield fetch(c, {
                          method: "POST",
                          headers: { "Content-Type": "application/json" },
                      ...
                      init() {
                        this.on("change:attributes:selectedData", () => {
                          ...
                          if (
                            ...
                            r.reset(),
                              t.forEach((t, n) => {
                                const e = (0, a.generateRandomString)();
                                r.add(
                                  `<div class="option-box-header colorAndQuantity" key="${n}" id="${e}">\n                <input type="hidden" id="size" name="size" value="${t}" />\n                      <h3>Size ${t}</h3>\n                      <p>আপনার পছন্দের রঙ এবং পরিমাণ নির্বাচন করুন</p>\n                    <div class="col-md-12 col-sm-6">\n                      <select id="colorList-${e}" class="form-control colorList" name="color" required>\n                        <option selected="true" disabled="disabled">Select a Color</option>\n                      </select>\n                    </div>\n                    <div class="col-md-12 col-sm-6" style="margin-top: 1rem;">\n                      <div class="row">\n                        <div class="col" style="align-items: center; justify-content: start; display: flex;">\n                        <label class="radio-label" for="quantity">পরিমাণ নির্বাচন করুন</label>\n                        </div>\n                        <div class="col" style="align-items: center; justify-content: start; display: flex;">\n                          <input id="quantity-${e}" class="quantity" name="quantity" class="form-control" type="number" value="0" required min="0"/>\n                        </div>\n                      </div>\n                    </div>\n                    </div>\n                    `
                                );
                              });
                            o.find(".colorList").forEach((t) => {
                              ...
                              n.forEach((t) => {
                                ...
                                console.log(t),
                                  t.includes("#")
                                    ? e.add(
                                        `<option value="${t}" style="background-color: ${a};">${n}</option>`
                                      )
                                    : e.add(
                                        `<option value="${t}">${t}</option>`
                                      );
                  ...
                  (n = a.data),
                    t.TraitManager.addType(o.typeBasicForm, {
                      ...
                      onEvent({ elInput: t, component: e }) {
                        ...
                        for (let t = 0; t < n.length; t++)
                          n[t].id == a.value &&
                            (n[t].value, a.value, (o = n[t]));
                        e.addAttributes({ selectedData: JSON.stringify(o) }),
                          (e.attributes.selectedData = JSON.stringify(o));
                      },
                    });
                } catch (t) {
                  console.log("Error in Fetching Data", t);
