                      ...
                      model: {
                        ...
                        init: function () {
                          ...
                          this.on(
                            ...
                            function () {
                              var e,
                                o = JSON.parse(n.getAttributes().selectedData);
                              console.log(o);
                              var a = t.getWrapper(),
                                i = a.find(".productId")[0],
                                r = a.find(".productPrice")[0],
                                s = a.find(".showProduct")[0];
                              s.get("components").reset();
                              var l = s.get("components");
                              if (
                                (i && r && s
                                  ? (i.set("attributes", { value: o.id }),
                                    r.set("attributes", { value: o.price }),
                                    r.set("style", { display: "none" }),
                                    l.add(
                                      '<span style="font-size: 20px; font-weight: 600; margin-right: 5px;" id="showProduct" class="showProduct">'.concat(
                                        o.price,
                                        "</span>BDT"
                                      )
                                    ),
                                ...
                                var c = o.color.split(","),
                                  d = a.find("#colorDiv")[0];
                                d.set("style", { display: "block" }),
                                  d.get("components").reset();
                                var u = d.get("components");
                                u.add(
                              ...
                              if (o.size) {
                                var m = o.size.split(","),
                                  b = a.find("#size")[0],
                                  g = b.get("components");
                                g.reset(), b.set("style", { display: "block" });
                                var h = g
                              ...
                              I(
                                {
                                  ...
                                  label: o[1],
                                  category: "Form",
                                  content: { type: g, data: O, components: A },
                                },
                                e
                              )
                            ),
                              ...
                              I(
                                {
                                  ...
                                  label: o[2],
                                  category: "Form",
                                  content: { type: h, data: O, components: P },
                                },
                                e
                              )
                            ),
