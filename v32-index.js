            ...
            const o = function () {
                ...
                function o(o) {
                  if (!n.value || "Choose a Color" === n.value) {
                    const t = document.getElementById("colorErr");
                    return (
                  ...
                  if (!e.value || "Choose a Size" === e.value) {
                    const t = document.getElementById("sizeErr");
                    return (
                      (t.style.display = "block"),
                      void setTimeout(() => {
                        t.style.display = "none";
                    ...
                    (n += o),
                      ...
                      (function (t) {
                        const n = document.getElementById("productPrice"),
                          e = document.getElementById("subTotalPrice");
                        if (n && e) {
                          const o = parseFloat(n.value) * t;
                          (e.textContent = "৳ " + o.toFixed(2)), console.log(e);
                        }
                      })(n);
                  }
                }
                const a = document.getElementById("decrement-btn");
                null !== a && a.addEventListener("click", () => o(-1));
                const i = document.getElementById("increment-btn");
                null !== i && i.addEventListener("click", () => o(1)),
