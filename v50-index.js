    ...
    (() => {
      ...
      var t = {
          956: (t, e, n) => {
            n.r(e),
              n.d(e, {
                addManageAttributesTraitToAllComponents: () => d,
                basicFormScript: () => b,
                generateRandomString: () => i,
                getExistingTemplate: () => s,
                getProductData: () => l,
                getSvgHtml: () => h,
                handleCreateAttributeModal: () => c,
                handleEditAttributemModal: () => p,
                multipleItemFormScript: () => g,
                shoppingFormScript: () => m,
                standardFormScript: () => u,
              });
            var a = n(360),
              o = n(128),
              r = n(496);
            ...
            function d(t) {
              t.DomComponents.getTypes().forEach((e) => {
                t.DomComponents.addType(e.id, {
                  model: {
                    defaults: {
                      traits: [
                        ...e.model.prototype.defaults.traits,
                        {
                          type: a.manageAttributesTrait,
                          name: "manageAttributes",
                          label: "Manage Attributes",
                          category: a.attributeCategory,
                        },
                      ],
                    },
                  },
            ...
            const c = function (t, e, n) {
                ...
                if (
                  ((r.innerHTML = o.addAttributeModal),
                  a.getTitle("Add New Attribute") && a.setContent(r),
                  a.isOpen())
                ) {
                  const n = a.getContent(),
                    o = n.querySelector(".addNewAttributeBtn");
                  o &&
                    o.addEventListener("click", () => {
                      const o = n.querySelector("#attributeNameInput")?.value,
                        r = n.querySelector("#attributeValueInput")?.value;
                      if (o && r) {
                        e.addAttributes({ [o]: r }), a.close();
                        t.TraitManager.getTraitsViewer().render();
                      } else
                        alert(
                          "Please enter both name and value for the attribute."
                        );
                    });
                }
              },
              p = function (t, e, n) {
                ...
                const r = document.createElement("div");
                if (
                  ((r.innerHTML = o.editAttributeModal),
                  a.getTitle("Edit Attribute") && a.setContent(r),
                  a.isOpen())
                ) {
                  const n = a.getContent(),
                    o = n.querySelector(".editAttributeBtn");
                  o &&
                    o.addEventListener("click", () => {
                      const o = n.querySelector("#attributeNameInput")?.value,
                        r = n.querySelector("#attributeValueInput")?.value;
              ...
              m = function () {
                document.addEventListener("DOMContentLoaded", function () {
                  const t = document.getElementById("shoppingFormquantity"),
                    ...
                    r = document.querySelector(".addToCart"),
                    i = document.getElementById("productPrice"),
                  ...
                  s && (s.textContent = "৳ " + p.toFixed(2)),
                    r.addEventListener("click", function () {
                      ...
                      const r = e.value,
                        l = n.value,
                        d = parseInt(t.value),
                        c = parseFloat(i.value),
                        p = c * d,
                        m = document.createElement("div");
                      (m.className =
                        "flex items-center justify-between gap-4 cartItems"),
                        (m.innerHTML = `<dl class="flex items-center justify-between gap-3 w-full"><dt class="text-base font-normal text-gray-500">${l} - ${r} x ${d}</dt><dd class="text-base font-medium text-gray-900">৳${p.toFixed(
                          2
              ...
              g = function () {
                ...
                const e = (e, a, o, r) => {
                    let i = document.getElementById("optionGroup" + e + "Sum");
                    i ||
                      ((i = document.createElement("li")),
                      (i.id = "optionGroup" + e + "Sum"),
                      (i.className = "order-summary"),
                      (i.innerHTML =
                    ...
                    const s = i.querySelector(".summary-text"),
                      l = i.querySelector(".price");
                    o > 0
                      ? ((s.textContent = a + " x " + o),
                        (l.textContent = "৳ " + (o * r).toFixed(2)))
                      : i.remove(),
                      n();
                  },
                  n = () => {
          ...
          476: function (t, e, n) {
            ...
            e["default"] = (t, e) =>
              a(void 0, void 0, void 0, function* () {
                const { block: n, id: a, category: s } = e,
                  l = yield (0, i.getProductData)();
                t.BlockManager.add(a[0], {
                  label: (0, i.getSvgHtml)(
                    t
                      .$(
                  ...
                  category: { id: s[1], label: s[1], open: !1 },
                  attributes: { class: "block-full-width" },
                  content: {
                    type: o.typeBasicForm,
                    data: l,
                    components: r.basicForm,
                  },
                }),
                  t.BlockManager.add(
                    a[1],
                  ...
                  t.BlockManager.add(a[3], {
                    ...
                    content: {
                      ...
                      data: l,
                      components: r.shoppingForm,
                    },
                  }),
                  t.BlockManager.add("link-block", {
                    label: "Link Block",
                    category: { id: s[0], label: s[0], open: !0 },
                    attributes: { class: "block-full-width" },
                  ...
                  t.BlockManager.add("quote", {
                    ...
                    content: r.blockquote,
                  }),
                  t.BlockManager.add(o.typeH1Block, {
                    label: "Heading",
                  ...
                  t.BlockManager.add("text-sect", {
                    ...
                    content: r.textSection,
                  }),
                  t.BlockManager.add("image", {
                    label: "Image",
                    category: { id: s[2], label: s[2], open: !1 },
                  ...
                  run: () =>
                    n(void 0, void 0, void 0, function* () {
                      const e = t.getHtml(),
                        ...
                        i = new URL(r),
                        s = new URLSearchParams(i.search).get("id"),
          ...
          126: (t, e, n) => {
            ...
            e["default"] = (t, e) => {
              ...
              const l = e.classPrefix,
                d = `${a.typeBasicForm}-container`;
              n.addType(a.typeBasicForm, {
                view: {
                  onRender() {
                ...
                model: {
                  ...
                  init() {
                    this.on("change:attributes:selectedData", () => {
                      var e;
                      const a = JSON.parse(this.getAttributes().selectedData);
                      console.log(a);
                      const o = t.getWrapper(),
                        r = o.find(".productId")[0],
                        i = o.find(".productPrice")[0],
                        s = o.find(".quantity")[0];
                      r.set("attributes", {
                        value: a.id,
                        name: "productId",
                      ...
                      let l =
                        ...
                        d =
                          null === (e = n.getById("token").view) || void 0 === e
                            ? void 0
                            : e.attr;
                      d
                        ? (d.value = l)
                    ...
                    init() {
                      this.on("change:attributes:selectedData", () => {
                        ...
                        if (
                          (r && i && s
                            ? (r.set("attributes", {
                              ...
                              l.add(
                                `<span class="showProduct text-gray-900 text-xl font-bold" id="showProduct">${a.price} BDT</span>`
                              ))
                            : console.error(
                          ...
                          const n = o.find("#colorSelect")[0].get("components");
                          n.reset(),
                            n.add(
                        ...
                        if (a.size) {
                          ...
                          const r = o.find("#sizeSelect")[0].get("components");
                          r.reset(),
                            r.add(
                ...
                n.addType(a.typemultipleItemForm, {
                  view: {
                    onRender() {
                      s = this.model.attributes.selectedData;
                    },
                  ...
                  model: {
                    defaults: {
                      ...
                      draggable: ":not(form)",
                      name: i[2],
                      script: o.multipleItemFormScript,
                      attributes: {
                    ...
                    init() {
                      this.on("change:attributes:selectedData", () => {
                        ...
                        const a = JSON.parse(this.getAttributes().selectedData),
                          r = t.getWrapper();
                        r.find("#orderSumList")[0].get("components").reset();
                        const i = r.find(".productId")[0],
                          s = r.find(".productPrice")[0];
                        if (
                          (s.set("attributes", {
                            value: a.price,
                            name: "productPrice",
                          ...
                          const t = a.size.split(","),
                            e = a.color.split(","),
                            n = r.find(".sizeColorAndQuantity")[0];
                          n.addAttributes({
                            style: "display: flex; justify-content: center;",
                          }),
                            n.get("components").reset();
                          const i = n.get("components");
                          i.reset(),
                            t.forEach((t, e) => {
                              const n = (0, o.generateRandomString)();
                              i.add(
          ...
          440: function (t, e, n) {
            ...
            e["default"] = (t, ...e) =>
              a(void 0, [t, ...e], void 0, function* (t, e = {}) {
                ...
                t.on("load", () => {
                  (0, p.getExistingTemplate)(),
                    t.runCommand("sortBlocks"),
                    (0, p.addManageAttributesTraitToAllComponents)(t);
                }),
                  t.on("update", () => {
          ...
          143: function (t, e, n) {
            ...
            e["default"] = (t) =>
              a(void 0, void 0, void 0, function* () {
                const e = yield (0, i.getProductData)();
                t.TraitManager.addType(o.productDataTrait, {
                  events: { keyup: "click" },
                  createInput({ trait: t }) {
                    const n = t.get("options") || [],
                      a = n.length ? n : e,
                      o = document.createElement("div");
                    o.innerHTML = `\n            <select class="products" style="background-color: #444; border: 1px solid #6e6e6e">\n            <option value="" disabled selected>Select a Product</option>\n              ${a
                  ...
                  onEvent({ elInput: t, component: n }) {
                    ...
                    for (let t = 0; t < e.length; t++)
                      e[t].id == a.value && (e[t].value, a.value, (o = e[t]));
                    n.addAttributes({ selectedData: JSON.stringify(o) }),
                      (n.attributes.selectedData = JSON.stringify(o));
                  },
                }),
                  t.TraitManager.addType(o.manageAttributesTrait, {
                    noLabel: !0,
                    createInput({ trait: t, component: e }) {
                      const n = t.get("options") || [],
                        a = (n.length, document.createElement("div"));
                      return (
                        ...
                        (a.style.gap = "1rem"),
                        (a.style.padding = "0.5rem 0 0.5rem 0"),
                        (a.innerHTML = `<table style="width: 100%;" class="addAttributeContainer">\n                        <thead style="font-size=13px;">\n                            <tr>\n                                <th>\n                                    Name\n                                </th>\n                                <th>\n                                    Value\n                                </th>\n                            </tr>\n                        </thead>\n                        <tbody>\n                            <tr>\n                                <td> No Attributes </td>\n                            </tr>\n                            \n                            \n                        </tbody>\n                    </table>\n                <button style="cursor: pointer;" id="addNewAttributeBtn">Add new +</button>\n                `),
                        a
                      );
                    },
                    onEvent({ elInput: t, component: e }) {},
                    onUpdate({ elInput: e, component: n, trait: a }) {
                      const o = e.querySelector(".addAttributeContainer tbody");
                      o.innerHTML = "";
                      ...
                      if (
                        ...
                        Object.entries(s).forEach(([t, e]) => {
                          ...
                          (n.className = "attributeRow"),
                            (n.innerHTML = `\n              <th>${t}</th> \n              <td>${
                              e.substring(0, 10) || ""
                            }</td>\n              <td style="cursor: pointer;" class="editAttributeBtn">\n                ${
                              r.pencilSvg
                            }\n              </td>\n            `),
                            o.appendChild(n);
                        }),
                        ...
                        (t.className = "noAttributesRow"),
                          (t.innerHTML = `\n            <td colspan="3" style="text-align: center; padding-top: 1rem;">No custom attributes</td>\n          `),
                          o.appendChild(t);
                      }
                      const l = e.querySelector("#addNewAttributeBtn");
                      l &&
                        l.addEventListener("click", () => {
                          (0, i.handleCreateAttributeModal)(t, n, a);
                        });
                      e.querySelectorAll(
                        ".attributeRow .editAttributeBtn"
                      ).forEach((e) => {
                        null == e ||
                          e.addEventListener("click", () => {
                            (0, i.handleEditAttributemModal)(t, n, a);
                          });
                      });
                    },
                  });
          ...
          360: (t, e) => {
            Object.defineProperty(e, "__esModule", { value: !0 }),
              ...
              (e.typeH1Block = "h1-block"),
              (e.productDataTrait = "productData"),
              (e.manageAttributesTrait = "manageAttributes"),
              (e.attributeCategory = {
                id: "manageAttribute",
                label: "Attributes",
              }),
              (e.productCategory = { id: "manageProduct", label: "Products" }),
              (e.blockCategory = ["Basic", "Form", "Extra"]);
          },
          128: (t, e) => {
            Object.defineProperty(e, "__esModule", { value: !0 }),
              (e.editAttributeModal =
                e.addAttributeModal =
                e.shoppingForm =
                e.basicForm =
                e.multipleItemForm =
              ...
              (e.h1Block = `<h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl block text-center"><span class="inline-block">Put your title here</span></h1>`),
              (e.textSection = `\n<div class="shadow-lg p-3 mb-5 bg-body rounded text-sect-head">\n <h1 class="text-2xl font-bold">Insert title here</h1>\n<p class="paragraph text-sect-p">\n  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua\n</p></div>\n`),
              ...
              (e.addAttributeModal = `\n<section class="attributeContainer">\n  <div class="attributeInputContainer">\n      <label for="attributeName">Name</label>\n      <input\n        id="attributeNameInput"\n        type="text"\n        name="attributeName"\n        placeholder="Insert Name"\n        value=""\n      />\n    </div>\n  <div class="attributeInputContainer">\n      <label for="attributeValue">Value</label>\n      <input\n        id="attributeValueInput"\n        type="text"\n        name="attributeValue"\n        placeholder="Insert Value"\n        value=""\n      />\n    </div>\n    <button id="createAttributeBtn" class="addNewAttributeBtn" type="button">Create +</button>\n</section>\n\n<style>\n  .attributeContainer {\n    display: flex;\n    flex-direction: column;\n    gap: 1rem;\n    justify-content: center;\n    align-items: center;\n    width: 100%;\n    margin: 1rem 0;\n  }\n  .attributeInputContainer {\n    display: flex;\n    gap: 1rem;\n    align-items: center;\n    justify-content: space-between;\n  }\n  .attributeInputContainer input {\n    padding: 0.5rem;\n    border: none;\n    outline: none;\n  }\n  .addNewAttributeBtn {\n    background-color: #d278c9;\n    padding: 0.3rem 1rem;\n    border: none;\n    color: white;\n    cursor: pointer;\n    font-weight: 700;\n  }\n  .addNewAttributeBtn:hover {\n    color: #000;\n  }\n</style>\n`),
              (e.editAttributeModal = `\n<section class="attributeContainer">\n  <div class="attributeInputContainer">\n      <label for="attributeName">Name</label>\n      <input\n        id="attributeNameInput"\n        type="text"\n        name="attributeName"\n        placeholder="Insert Name"\n        value=""\n      />\n    </div>\n  <div class="attributeInputContainer">\n      <label for="attributeValue">Value</label>\n      <input\n        id="attributeValueInput"\n        type="text"\n        name="attributeValue"\n        placeholder="Insert Value"\n        value=""\n      />\n    </div>\n    <button id="editAttributeBtn" class="editAttributeBtn" type="button">Update</button>\n    <button id="deleteAttributeBtn" class="deleteAttributeBtn" type="button">Delete</button>\n</section>\n\n<style>\n  .attributeContainer {\n    display: flex;\n    flex-direction: column;\n    gap: 1rem;\n    justify-content: center;\n    align-items: center;\n    width: 100%;\n    margin: 1rem 0;\n  }\n  .attributeInputContainer {\n    display: flex;\n    gap: 1rem;\n    align-items: center;\n    justify-content: space-between;\n  }\n  .attributeInputContainer input {\n    padding: 0.5rem;\n    border: none;\n    outline: none;\n  }\n  .addNewAttributeBtn {\n    background-color: #d278c9;\n    padding: 0.3rem 1rem;\n    border: none;\n    color: white;\n    cursor: pointer;\n    font-weight: 700;\n  }\n  .addNewAttributeBtn:hover {\n    color: #000;\n  }\n</style>\n`);
          },
          496: (t, e) => {
            Object.defineProperty(e, "__esModule", { value: !0 }),
              (e.pencilSvg = e.basicFormSvg = e.productDummyData = void 0),
              (e.productDummyData = [
                {
                  id: 9,
                  user_id: 1,
