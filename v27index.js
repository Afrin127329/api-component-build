  ...
  () =>
    (() => {
      ...
      var t = {
          879: (t, n, e) => {
            e.r(n),
              e.d(n, { multipleItemFormScript: () => a, script: () => o });
            const o = function () {
                function t(t) {
                        ...
                        Object.assign(
                          {
                            ...
                            attributes: {
                              dataImage:
                                "https://cdn.jsdelivr.net/gh/Afrin127329/api-component-assets@master/basicForm.png",
                            },
                            content: {
          ...
          707: function (t, n) {
            ...
            n.loadStyle = (t) =>
              e(void 0, void 0, void 0, function* () {
                t.on("block:add", (t) => {
                  const n = t.attributes.attributes.dataImage;
                  if ((console.log(t.get("attributes").class), n)) {
                    const e = `block-hover-${Date.now()}-${Math.floor(
                      1e3 * Math.random()
                    )}`;
                    t.set(
                      "attributes",
                      Object.assign(Object.assign({}, t.get("attributes")), {
                        class: `${t.get("attributes").class || ""} ${e}`,
                      })
                    );
                    let o = document.getElementById("custom-hover-style");
                    o ||
                      ((o = document.createElement("style")),
                      (o.id = "custom-hover-style"),
